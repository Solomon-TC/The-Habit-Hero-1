                ...
                <div className="space-y-4">
                  <div className="border rounded-lg p-4">
                    ...
                    <p className="text-gray-600 mt-1">
                      Streaks increase by 1 each day you complete a habit. If
                      you miss a day, your streak resets to 0.
                    </p>
                  </div>
                  <div className="border rounded-lg p-4">
                    ...
                    <p className="text-gray-600 mt-1">
                      Yes, you can edit any habit to change its frequency
                      between daily, weekly, or monthly tracking.
                    </p>
                  </div>
                  <div className="border rounded-lg p-4">
                    ...
                    <p className="text-gray-600 mt-1">
                      ...
                      milestones, like maintaining a streak or completing
                      specific challenges.
                    </p>
                  </div>
                </div>
